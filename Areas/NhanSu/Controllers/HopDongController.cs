...
namespace BTL.Areas.NhanSu.Controllers
{
    public class HopDongController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.NhanViens = db.NhanViens.ToDictionary(n => n.MaNV, n => n.HotenNV);
            return View(hd);
        }
        ...
        {
            if (!ModelState.IsValid) { ViewBag.NhanViens = new SelectList(db.NhanViens.ToList(), "MaNV", "HotenNV", m.MaNV); return View(m); }
